...
public class ReserveListController {
    ...
    private void handleAddReservation() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/AddRoom.fxml"));
    ...
    private void handleEditReservation() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/EditRoom.fxml"));
            Parent root = loader.load();
